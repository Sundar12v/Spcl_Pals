    ...
    return Scaffold(
      body: Column(
        children: <Widget>[
          ...
          SizedBox(height: 10,),
          Text('Toucan moms lay two \n         to four eggs.', style: TextStyle(
              color: Colors.black, fontWeight: FontWeight.bold, fontSize: 24, fontFamily: 'Nunito'
          ),),
          SizedBox(height: 20,),
          Container(
            child: Image(image: AssetImage('assets/toucan.png'),height: 230, width: 420,),
          ),
          SizedBox(height: 25,),
          Row(children: <Widget>[
            SizedBox(width: 50,),
            InkWell(
              onTap: () async {
                  await _audioPlayer.play(AssetSource('Toucan.mp3'));
                },
              child: Container(
                width: 70,
                height: 50,
          ...
          SizedBox(height: 25,),
          Text(
            'A Toucan makes a clattering sound.',style: TextStyle(
...
Widget _step0(){
  return Container(
    ...
    child:  Center(
      child: Text('Toucans are renowned for \n their large colorful bills.', style: TextStyle( fontWeight: FontWeight.w600,fontFamily: 'NunitoSans', fontSize: 18),),
    ),
  );
}
...
Widget _step1(){
  return Container(
    ...
    color: Colors.deepOrangeAccent[100],
    child:  Center(
      child: Text("The Toucan's bill is very light \n as it is made of keratin.", style: TextStyle(fontWeight: FontWeight.w600,fontFamily: 'NunitoSans', fontSize: 18),),
    ),
  );
}
...
Widget _step2(){
  return Container(
    ...
    color: Colors.deepOrangeAccent[100],
    child:  Center(
      child: Text('Toco Toucans also use their \n beaks to pluck and peel fruit.', style: TextStyle(fontWeight: FontWeight.w600,fontFamily: 'NunitoSans', fontSize: 18),),
    ),
  );
}
