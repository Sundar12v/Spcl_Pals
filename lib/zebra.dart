      ...
      body: Column(
        children: <Widget>[
          ...
          Row(children: <Widget>[
            ...
            InkWell(
              onTap: () async {
                  await _audioPlayer.play(AssetSource('Zebra.mp3'));
                },
              child: Container(
                width: 70,
                height: 50,
          ...
          SizedBox(height: 25,),
          Text(
            'A Zebra makes a snorting sound.',style: TextStyle(
...
Widget _step0(){
  return Container(
    ...
    child:  Center(
      child: Text('Zebras are single-hoofed animals \n that are native to Africa.', style: TextStyle( fontWeight: FontWeight.w600,fontFamily: 'NunitoSans', fontSize: 18),),
    ),
  );
}
...
Widget _step1(){
  return Container(
    ...
    color: Colors.deepOrangeAccent[100],
    child:  Center(
      child: Text(" Each species of zebra has a \n different general pattern of stripes.", style: TextStyle(fontWeight: FontWeight.w600,fontFamily: 'NunitoSans', fontSize: 18),),
    ),
  );
}
...
Widget _step2(){
  return Container(
    ...
    color: Colors.deepOrangeAccent[100],
    child:  Center(
      child: Text('The most prominent feature \n of zebras is the bold patterns \n on their coats. ', style: TextStyle(fontWeight: FontWeight.w600,fontFamily: 'NunitoSans', fontSize: 18),),
    ),
  );
}
